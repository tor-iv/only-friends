    ...
    >
      ...
      <View className="flex-1 ml-3">
        <View className="flex-row items-center">
          ...
          <Text className="ml-2 text-xs font-sans text-charcoal-300">
            {formatTimestamp(comment.created_at)}
          </Text>
        </View>
        <Text className="font-sans text-charcoal-400 mt-1">
          {comment.content}
        </Text>
      </View>
    </TouchableOpacity>
...
export function PostDetailScreen() {
  ...
  const handleUserPress = (userId: string) => {
    // @ts-expect-error - navigation type is complex
    ...
    return (
      <View>
        <PostCard
          ...
          onCommentPress={() => {}} // Already on detail screen
    ...
    <SafeAreaView className="flex-1 bg-cream-300" edges={["top"]}>
      ...
      >
        ...
        <View className="flex-row items-center px-4 py-3 border-b border-cream-400">
          ...
          <Text className="ml-4 font-serif-bold text-lg text-charcoal-400">
            Post
          </Text>
        </View>
        ...
        <View className="flex-row items-center px-4 py-3 border-t border-cream-400 bg-cream-300">
          <TextInput
            ...
            className="flex-1 font-sans text-charcoal-400 bg-white rounded-full px-4 py-2 mr-2"
            maxLength={500}
          />
          <TouchableOpacity
